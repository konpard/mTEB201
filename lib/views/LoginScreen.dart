          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                ...
                child: FadeInRight(
                  ...
                  child: Container(
                      ...
                      child: const Text(' Не помню пароль! ', style: TextStyle(color: Colors.cyan,fontWeight: FontWeight.bold),)),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: FadeInUp(
                    duration: const Duration(milliseconds: 1000),
                    child: const Card(child: Text('Не получилось войти ', style: TextStyle(color: Colors.cyan,fontWeight: FontWeight.bold),))),
              ),
