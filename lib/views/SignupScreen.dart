            ...
            children: [
              ...
              FadeInUp(
                  ...
                  child: ElevatedButton(onPressed: () async {
                    ...
                    EasyLoading.dismiss();
                    Fluttertoast.showToast(msg: "Регистрация успешна!");
              ...
              GestureDetector(
                ...
                child: FadeInUp(
                    duration: const Duration(milliseconds: 1000),
                    child: const Card(child: Text(' Аккаунт с таким логином уже существует ', style: TextStyle(color: Colors.cyan,fontWeight: FontWeight.bold),))),
              ),
